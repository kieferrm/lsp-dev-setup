...
SCRIPTDIR=`dirname $0`
cp -f ../${SCRIPTDIR}/vscode-definitions/1.22.prerelease/vscode.d.ts vscode-languageserver-node/client/node_modules/vscode 
cp -f ../${SCRIPTDIR}/vscode-definitions/1.22.prerelease/vscode.d.ts vscode-extension-samples/lsp-sample/client/node_modules/vscode
